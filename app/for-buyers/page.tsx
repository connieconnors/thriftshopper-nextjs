          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <Card>
              <CardContent className="p-8 text-center">
                <Search className="w-16 h-16 mx-auto mb-6" style={{ color: "#000080" }} />
            ...
            <Card>
              <CardContent className="p-8 text-center">
                <Bell className="w-16 h-16 mx-auto mb-6" style={{ color: "#000080" }} />
            ...
            <Card>
              <CardContent className="p-8 text-center">
                <Heart className="w-16 h-16 mx-auto mb-6" style={{ color: "#000080" }} />
